...
export default function Widget() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <header
        className="py-4 px-2.5 sticky top-0 z-50 bg-white bg-opacity-50 backdrop-blur border-b border-slate-100"
      >
      ...
      <footer
        className="px-4 py-3 flex items-center justify-between sticky bottom-0 z-50 bg-white bg-opacity-50 backdrop-blur-xl text-xs border-t border-slate-100"
      >
        <a
